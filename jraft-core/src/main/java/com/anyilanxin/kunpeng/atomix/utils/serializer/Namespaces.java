...
public final class Namespaces {
    ...
    public static final Namespace BASIC                = new Namespace.Builder()
                                                           ...
                                                           .register(new ImmutableListSerializer(),
                                                               ImmutableList.class, ImmutableList.of(1).getClass(),
                                                           ...
                                                           .register(Void.class)
                                                           // placeholder for the deleted LogicalTimestamp class
                                                           .register(Void.class)
                                                           // placeholder for the deleted WallClockTimestamp class
                                                           .register(Version.class)
                                                           .register(new ByteBufferSerializer(), ByteBuffer.class,
                                                               ByteBuffer.allocate(1).getClass(),
                                                               ByteBuffer.allocateDirect(1).getClass()).name("BASIC")
                                                           .build();
