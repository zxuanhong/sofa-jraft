...
class MessageDecoderV2 extends AbstractMessageDecoder {
            ...
            case REQUEST:
                switch (currentState) {
                    ...
                    case READ_SUBJECT:
                        ...
                        final ProtocolRequest message = new ProtocolRequest(messageId, senderAddress, subject, content);
                        out.add(message);
                        currentState = DecoderState.READ_TYPE;
                        break;
                    default:
    ...
    /** V2 decoder state. */
    enum DecoderState {
        READ_TYPE, READ_MESSAGE_ID, READ_SENDER_HOST_LENGTH, READ_SENDER_HOST, READ_SENDER_PORT, READ_SUBJECT_LENGTH, READ_SUBJECT, READ_STATUS, READ_CONTENT_LENGTH, READ_CONTENT
    }
}
