...
import static com.anyilanxin.kunpeng.util.concurrent.Threads.namedThreads;
...
import com.anyilanxin.kunpeng.atomix.cluster.impl.AddressSerializer;
...
import com.anyilanxin.kunpeng.atomix.utils.serializer.Namespace;
import com.anyilanxin.kunpeng.atomix.utils.serializer.Namespaces;
import com.anyilanxin.kunpeng.atomix.utils.serializer.Serializer;
...
public class SwimMembershipProtocol
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.atomix.cluster.protocol.swim");
  private static final Logger GOSSIP_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.atomix.cluster.protocol.swim.gossip");
  private static final Logger PROBE_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.atomix.cluster.protocol.swim.probe");
  private static final Logger SYNC_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.atomix.cluster.protocol.swim.sync");
