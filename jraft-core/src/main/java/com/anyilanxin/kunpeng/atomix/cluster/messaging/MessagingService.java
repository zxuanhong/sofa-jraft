...
public interface MessagingService {
   ...
   *       default timeout
   *   <li>{@link
   *       com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingException.ProtocolException} -
   *       indicates the recipient failed to parse the incoming message
   *   <li>{@link
   *       com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingException.NoRemoteHandler} -
   *       indicates the recipient received the message, but was no expecting to
   *   <li>{@link
   *       com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingException.RemoteHandlerFailure}
