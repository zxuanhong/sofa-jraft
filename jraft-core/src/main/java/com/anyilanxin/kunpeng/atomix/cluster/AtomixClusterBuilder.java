...
import com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingConfig.CompressionAlgorithm;
...
import com.anyilanxin.kunpeng.util.VersionUtil;
 ...
 * }</pre>
 *
 * <p>The instance is configured by calling the {@code with*} methods on this builder. Once the
 ...
 * }</pre>
 *
 * <p>Backing the builder is an {@link ClusterConfig} which is loaded when the builder is initially
 * constructed. To load a configuration from a file, use {@link AtomixCluster#builder()}.
 */
public class AtomixClusterBuilder implements Builder<AtomixCluster> {
     ...
     * @return the cluster builder
     * @see com.anyilanxin.kunpeng.atomix.cluster.protocol.SwimMembershipProtocol
     */
     ...
     * @return the cluster builder
     * @see com.anyilanxin.kunpeng.atomix.cluster.discovery.BootstrapDiscoveryProvider
     */
     ...
     * @return the cluster builder
     * @see com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingConfig#setTlsEnabled(boolean)
     * @see com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingConfig#setCertificateChain(File)
     * @see com.anyilanxin.kunpeng.atomix.cluster.messaging.MessagingConfig#setPrivateKey(File)
     */
    public AtomixClusterBuilder withSecurity(final File certificateChain, final File privateKey) {
        config.getMessagingConfig().setTlsEnabled(true).setCertificateChain(certificateChain).setPrivateKey(privateKey);

        return this;
    }

    public AtomixClusterBuilder withMessageCompression(final CompressionAlgorithm messageCompression) {
