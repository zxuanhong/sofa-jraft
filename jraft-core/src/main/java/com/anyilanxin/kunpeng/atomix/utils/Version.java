...
import com.anyilanxin.kunpeng.util.SemanticVersion;
...
public final class Version implements Comparable<Version> {
    ...
    private Version(final int major, final int minor, final int patch, final String build, final String metadata) {
        this.major = major;
        this.minor = minor;
        this.patch = patch;
        this.build = build;
